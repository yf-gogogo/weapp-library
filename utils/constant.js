 ...
 */
export const STATUS_WAITING_FOR_OTHERS_TO_RETURN = 1001

/**
 * 1002: others have returned. Wait for user to take the book.
 * 其他用户已经归还图书，正在等待用户取书.
 */
export const STATUS_WAITING_TO_TAKE_RETURNED_BOOK = 1002

/**
 * 1003: Wait for user to take the book at the planed time.
 * 预订中: 图书充足，用户预订此图书，将在约定的时间前往图书馆取书.
 */
export const STATUS_WAITING_TO_TAKE_AT_PLANED_TIME = 1003

/**
 * 1004: User have taken the book, not returned yet.
 * 借书借阅中.
 */
export const STATUS_BORROWING = 1004
 ...
 * 正常关闭.
 */
export const STATUS_NORMAL_CLOSE = 1011

/**
 * 1012: Return book and close order abnormally.
 * 非正常关闭, 需要支付罚金. 如图书损坏.
 */
export const STATUS_ABNORMAL_CLOSE = 1012
 ...
 */
export const STATUS_CANCELED_BY_USER = 1021
